...
namespace ProDiegoV1.Migrations
{
    ...
    [Migration("20240928142227_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProDiegoV1.models.College", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProDiegoV1.models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ProDiegoV1.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ProDiegoV1.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ProDiegoV1.models.Student", b =>
                {
                    b.HasOne("ProDiegoV1.models.College", "College")
                        .WithMany()
