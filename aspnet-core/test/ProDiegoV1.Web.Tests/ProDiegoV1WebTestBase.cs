...
{
    public abstract class ProDiegoV1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProDiegoV1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProDiegoV1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProDiegoV1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProDiegoV1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProDiegoV1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProDiegoV1DbContext, Task<T>> func)
        {
            T result;
