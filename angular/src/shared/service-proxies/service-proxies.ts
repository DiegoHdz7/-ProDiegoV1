...
export class StudentServiceProxy {
    ...
    getMyCustomList(): Observable<StudentDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Student/GetMyCustomList";
        url_ = url_.replace(/[?&]$/, "");
    ...
    createMyCustomStudentV1(body: CreateStudentDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Student/CreateMyCustomStudentV1";
        url_ = url_.replace(/[?&]$/, "");
    ...
    createMyCustomStudentV2(body: CreateStudentDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Student/CreateMyCustomStudentV2";
        url_ = url_.replace(/[?&]$/, "");
